...
* [etcd](#etcd)
	* [Etcd主要功能](#etcd主要功能)
	* [Etcd基于RAFT的一致性](#etcd基于raft的一致性)
		* [wal日志](#wal日志)
	* [Etcd v2 与 v3](#etcd-v2-与-v3)
	* [Etcd v2 存储，Watch以及过期机制](#etcd-v2-存储watch以及过期机制)
	* [Etcd v3 存储，Watch以及过期机制](#etcd-v3-存储watch以及过期机制)
	* [Etcd，Zookeeper，Consul 比较](#etcdzookeeperconsul-比较)
	* [Etcd 的周边工具](#etcd-的周边工具)
...
* [kubernetes-handbook/etcd.md at master · feiskyer/kubernetes-handbook ](https://github.com/feiskyer/kubernetes-handbook/blob/master/components/etcd.md)
* [3.1 etcd · Kubernetes指南 ](https://feisky.gitbooks.io/kubernetes/components/etcd.html)
