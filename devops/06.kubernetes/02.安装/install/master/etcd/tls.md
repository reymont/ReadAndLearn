...
* [Transport security model](#transport-security-model)
	...
	* [Example 2: Client-to-server authentication with HTTPS client certificates](#example-2-client-to-server-authentication-with-https-client-certificates)
	...
	* [Example 4: Automatic self-signed transport security](#example-4-automatic-self-signed-transport-security)
	* [Notes for etcd proxy](#notes-for-etcd-proxy)
	* [Frequently asked questions](#frequently-asked-questions)
		* [I'm seeing a SSLv3 alert handshake failure when using TLS client authentication?](#im-seeing-a-sslv3-alert-handshake-failure-when-using-tls-client-authentication)
		* [With peer certificate authentication I receive "certificate is valid for 127.0.0.1, not $MY_IP"](#with-peer-certificate-authentication-i-receive-certificate-is-valid-for-127001-not-my_ip)
...
* [etcd/security.md at master · coreos/etcd ](https://github.com/coreos/etcd/blob/master/Documentation/op-guide/security.md)
