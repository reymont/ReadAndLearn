...
logstash/log4j-jsonevent-layout: A prefab PatternLayout for log4j that generates logstash json_event formatted data https://github.com/logstash/log4j-jsonevent-layout
...
If you've used log4j, you know that certain appenders support things called "Layouts". These are basically ways for you to control the formatting/rendering of a log event.

There's a full list of formatting macros here if you're curious.
...
I recently came to a situation where I needed consider parsing some log4j-generated log events with Logstash. I had another appender already but unfortunately the external dependency on ZeroMQ itself was a no go. So there were two options:
...
Then I remembered the "hack" that would let you dump your apache or nginx logs in json_event format.
