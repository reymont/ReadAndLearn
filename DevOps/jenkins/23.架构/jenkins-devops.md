...
node('master'){
def M3=tool 'M3'
def pomDir='ob-devops'
def S3=tool 'S3'
def pushDockerImage='docker.cloudos.yihecloud.com/cloudos/devops:5.0-$BUILD_TIMESTAMP'
def scm_git_url='git@git.yihecloud.com:PaaS/OpenBridge-DevOps-API.git'
def scm_git_credentialId='credential_1496064914173'
def scm_git_branch='develop'
if (isUnix()) {
stage('更新代码'){
parallel'1_更新代码_git_task_1499745823618': {
def credentialId="credential_1496064914173"
def branch="develop"
def url="git@git.yihecloud.com:PaaS/OpenBridge-DevOps-API.git"
