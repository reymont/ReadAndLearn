...
* [Calico-https-etcd-k8s-v2.1.5最新版集群布署](#calico-https-etcd-k8s-v215最新版集群布署)
	* [DaemonSet](#daemonset)
		* [非http 连接etcd  配置](#非http-连接etcd-配置)
		* [https 如下](#https-如下)
	* [rbac](#rbac)
	* [1.无https 连接etcd方案](#1无https-连接etcd方案)
	* [2.https  证书连接etcd方案](#2https-证书连接etcd方案)
		* [检查状态 所有node启动正常](#检查状态-所有node启动正常)
	* [ansible](#ansible)
		* [停止所有服务](#停止所有服务)
		* [删除文件](#删除文件)
		* [重启node](#重启node)
...
目前k8s 网络最快的第一就是`Calico`，第二种稍慢`flannel`，根据自己的网络环境条件来定
