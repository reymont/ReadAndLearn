...
* [confd/templates.md at master · kelseyhightower/confd ](https://github.com/kelseyhightower/confd/blob/master/docs/templates.md)
...
* [Templates](#templates)
	* [Template Functions](#template-functions)
		...
		* [json](#json)
		* [lookupSRV](#lookupsrv)
			* [Add keys to etcd](#add-keys-to-etcd)
			* [Create the template resource](#create-the-template-resource)
			* [Create the template](#create-the-template)
			* [Advanced Map Traversals](#advanced-map-traversals)
		* [jsonArray](#jsonarray)
		* [ls](#ls)
		* [lsdir](#lsdir)
		* [dir](#dir)
	...
	* [Example Usage](#example-usage)
		* [Complex example](#complex-example)
			* [Add keys to etcd](#add-keys-to-etcd-1)
			* [Create the template resource](#create-the-template-resource-1)
			* [Create the template](#create-the-template-1)
