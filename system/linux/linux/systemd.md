...
* [Systemd 入门教程：命令篇](#systemd-入门教程命令篇)
	* [一、由来](#一-由来)
	* [二、Systemd 概述](#二-systemd-概述)
	* [三、系统管理](#三-系统管理)
		* [3.1 systemctl](#31-systemctl)
		* [3.2 systemd-analyze](#32-systemd-analyze)
		* [3.3 hostnamectl](#33-hostnamectl)
		* [3.4 localectl](#34-localectl)
		* [3.5 timedatectl](#35-timedatectl)
		* [3.6 loginctl](#36-loginctl)
	* [四、Unit](#四-unit)
		* [4.1 含义](#41-含义)
		* [4.2 Unit 的状态](#42-unit-的状态)
		* [4.3 Unit 管理](#43-unit-管理)
		* [4.4 依赖关系](#44-依赖关系)
	* [五、Unit 的配置文件](#五-unit-的配置文件)
		* [5.1 概述](#51-概述)
		* [5.2 配置文件的状态](#52-配置文件的状态)
		* [5.3 配置文件的格式](#53-配置文件的格式)
		* [5.4 配置文件的区块](#54-配置文件的区块)
	* [六、Target](#六-target)
	* [七、日志管理](#七-日志管理)
...
* [articles/2016-03-07-systemd.md at master · ruanyf/articles ](https://github.com/ruanyf/articles/blob/master/2016/2016-03-07-systemd.md)
# Systemd 入门教程：命令篇
